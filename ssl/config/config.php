...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost:8080/mizan/php/project/php-ecommerce/'); // replace this value with your project path
}
...
return [
    'success_url' => '../frontEnd/orderSuccess.php', // your success url
