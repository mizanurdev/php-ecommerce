...
$post_data = array();
$post_data['total_amount'] = isset($_POST['amount']) ? $_POST['amount'] : " ";
$post_data['payment_type'] = isset($_POST['payment_type']) ? $_POST['payment_type'] : " ";
$post_data['currency'] = "BDT";
$post_data['tran_id'] = "SSLCZ_TEST_" . uniqid();

# CUSTOMER INFORMATION
$post_data['cus_first_name'] = isset($_POST['first_name']) ? $_POST['first_name'] : "John";
$post_data['cus_last_name'] = isset($_POST['last_name']) ? $_POST['last_name'] : "Doe";
$post_data['cus_name'] = $post_data['cus_first_name']." ".$post_data['cus_last_name'];
$post_data['cus_email'] = isset($_POST['email']) ? $_POST['email'] : "john.doe@email.com";
$post_data['cus_add1'] = isset($_POST['address_one']) ? $_POST['address_one'] : "Dhaka";
$post_data['cus_add2'] = isset($_POST['address_two']) ? $_POST['address_two'] : "Bangladesh";
$post_data['cus_city'] = isset($_POST['city_id']) ? $_POST['city_id'] : "Dhaka";
$post_data['cus_state'] = isset($_POST['state_id']) ? $_POST['state_id'] : "Mugda";
$post_data['cus_postcode'] = isset($_POST['zip_code']) ? $_POST['zip_code'] : "1217";
$post_data['cus_country'] = isset($_POST['country_id']) ? $_POST['country_id'] : "Bangladesh";
$post_data['cus_phone'] = isset($_POST['cell']) ? $_POST['cell'] : "01711111111";
$post_data['cus_account'] = isset($_POST['account']) ? $_POST['account'] : " ";
...
$query = new OrderTransaction($conn);
$query->saveTransactionQuery($post_data);
unset($_SESSION['cart']);

if($post_data['payment_type'] == 'ssl'){
    if ($query) {
...
}else if($post_data['payment_type'] == 'cod'){
    // Define the array with POST data
    $post_data = array(
    ...
    ?>
    <form id="postForm" action="../frontEnd/orderSuccess.php" method="POST">
        <?php
        // Convert the array into hidden form fields
