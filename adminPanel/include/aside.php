          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="../index.php">
                ...
                <span class="brand-name">MINI MART</span>
              </a>
            </div>
            ...
            <div class="sidebar-left" data-simplebar style="height: 100%;">
              ...
              <?php
                if (isset($_SESSION['id'])) {
                    ...
                    // Prepare and execute the query securely using MySQLi
                    $sql = "SELECT * FROM user WHERE id = ? AND user_type = 'admin'";
                        ...
                        <li  class="has-sub" >
                          ...
                          <ul  class="collapse"  id="user"
                            ...
                            <div class="sub-menu">
                                  ...
                                  <li >
                                    <a class="sidenav-item-link" href="userRetrive.php">
                        ...
                        <li  class="has-sub" >
                              ...
                              <ul  class="collapse"  id="category"
                                ...
                                <div class="sub-menu">
                                      ...
                                      <li >
                                        <a class="sidenav-item-link" href="categoryAll.php">
                                      ...
                                      <li >
                                        <a class="sidenav-item-link" href="categoryAdd.php">
                        ...
                        <li  class="has-sub" >
                          ...
                          <ul  class="collapse"  id="brand"
                            ...
                            <div class="sub-menu">
                                  ...
                                  <li >
                                    <a class="sidenav-item-link" href="brandAll.php">
                                  ...
                                  <li >
                                    <a class="sidenav-item-link" href="brandAdd.php">
                        ...
                        <li  class="has-sub" >
                          ...
                          <ul  class="collapse"  id="product"
                            ...
                            <div class="sub-menu">
                                  ...
                                  <li >
                                    <a class="sidenav-item-link" href="productAll.php">
                                  ...
                                  <li >
                                    <a class="sidenav-item-link" href="productAdd.php">
                        ...
                        <li  class="has-sub" >
                          ...
                          <ul  class="collapse"  id="order"
                            ...
                            <div class="sub-menu">
                                  ...
                                  <li >
                                    <a class="sidenav-item-link" href="orderAll.php">
                      ...
                      <li  class="has-sub" >
                          ...
                          <ul  class="collapse"  id="user"
                            ...
                            <div class="sub-menu">
                                  ...
                                  <li >
                                    <a class="sidenav-item-link" href="userRetrive.php?id=<?php echo $_SESSION['id'] ?>">
                      ...
                      <li  class="has-sub" >
                          ...
                          <ul  class="collapse"  id="order"
                            ...
                            <div class="sub-menu">
                                  ...
                                  <li >
                                    <a class="sidenav-item-link" href="orderAll.php?id=<?php echo $_SESSION['id'] ?>">
                                      <span class="nav-text">All Order</span>
