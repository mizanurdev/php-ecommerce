      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <a href="dashboard.php"><span class="page-title">dashboard</span></a>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="<?php if(isset($_SESSION['image'])){echo $_SESSION['image'];}?>" class="user-image rounded-circle" alt="User" />
                      <span class="d-none d-lg-inline-block"><?php if(isset($_SESSION['username'])){echo $_SESSION['username'];}?></span>
                    </button>
